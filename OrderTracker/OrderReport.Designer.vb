...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("OrderReport"),  _
...
Partial Public Class OrderReport
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As OrderReport = CType(MyBase.Clone,OrderReport)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "OrderReport"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/OrderReport.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As OrderReport = New OrderReport()
    ...
    Partial Public Class TableDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddTableRow(ByVal OrderNo As String, ByVal Customer As String, ByVal Project As String, ByVal Delivery_Date As Date) As TableRow
            Dim rowTableRow As TableRow = CType(Me.NewRow,TableRow)
            Dim columnValuesArray() As Object = New Object() {OrderNo, Customer, Project, Delivery_Date}
...
Namespace OrderReportTableAdapters
    ...
    Partial Public Class TableTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (((@IsNull_OrderNo = 1 AND [OrderNo] IS NULL) OR "& _ 
                "([OrderNo] = @Original_OrderNo)) AND ([Customer] = @Original_Customer) AND ((@Is"& _ 
                "Null_Project = 1 AND [Project] IS NULL) OR ([Project] = @Original_Project)) AND "& _ 
                "((@IsNull_Delivery_Date = 1 AND [Delivery Date] IS NULL) OR ([Delivery Date] = @"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([OrderNo], [Customer], [Project], [Delivery Date]) VAL"& _ 
                "UES (@OrderNo, @Customer, @Project, @Delivery_Date);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT OrderNo, Customer, "& _ 
                "Project, [Delivery Date] FROM [Table] WHERE (Customer = @Customer)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [OrderNo] = @OrderNo, [Customer] = @Customer, [Project] "& _ 
                "= @Project, [Delivery Date] = @Delivery_Date WHERE (((@IsNull_OrderNo = 1 AND [O"& _ 
                "rderNo] IS NULL) OR ([OrderNo] = @Original_OrderNo)) AND ([Customer] = @Original"& _ 
                "_Customer) AND ((@IsNull_Project = 1 AND [Project] IS NULL) OR ([Project] = @Ori"& _ 
                "ginal_Project)) AND ((@IsNull_Delivery_Date = 1 AND [Delivery Date] IS NULL) OR "& _ 
                "([Delivery Date] = @Original_Delivery_Date)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT OrderNo, Customer, Projec"& _ 
                "t, [Delivery Date] FROM [Table] WHERE (Customer = @Customer)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT OrderNo, Customer, Project, [Delivery Date] FROM dbo.[Table]"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As OrderReport.TableDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As OrderReport.TableDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As OrderReport.TableDataTable = New OrderReport.TableDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As OrderReport.TableDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As OrderReport) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_OrderNo As String, ByVal Original_Customer As String, ByVal Original_Project As String, ByVal Original_Delivery_Date As Global.System.Nullable(Of Date)) As Integer
            If (Original_OrderNo Is Nothing) Then
                Me.Adapter.DeleteCommand.Parameters(0).Value = CType(1,Object)
                Me.Adapter.DeleteCommand.Parameters(1).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.DeleteCommand.Parameters(0).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(1).Value = CType(Original_OrderNo,String)
            End If
        ...
        Public Overloads Overridable Function Insert(ByVal OrderNo As String, ByVal Customer As String, ByVal Project As String, ByVal Delivery_Date As Global.System.Nullable(Of Date)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal OrderNo As String, ByVal Customer As String, ByVal Project As String, ByVal Delivery_Date As Global.System.Nullable(Of Date), ByVal Original_OrderNo As String, ByVal Original_Customer As String, ByVal Original_Project As String, ByVal Original_Delivery_Date As Global.System.Nullable(Of Date)) As Integer
            If (OrderNo Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(Original_OrderNo,String)
            End If
            If (Original_Customer Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_Customer")
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(8).Value = CType(Original_Project,String)
            End If
            If (Original_Delivery_Date.HasValue = true) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal OrderNo As String, ByVal Project As String, ByVal Delivery_Date As Global.System.Nullable(Of Date), ByVal Original_OrderNo As String, ByVal Original_Customer As String, ByVal Original_Project As String, ByVal Original_Delivery_Date As Global.System.Nullable(Of Date)) As Integer
            Return Me.Update(OrderNo, Original_Customer, Project, Delivery_Date, Original_OrderNo, Original_Customer, Original_Project, Original_Delivery_Date)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As OrderReport, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As OrderReport, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._tableTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As OrderReport, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._tableTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As OrderReport) As Integer
